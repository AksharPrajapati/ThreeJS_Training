...
const shadowPlan = new THREE.Mesh(
...
shadowPlan.position.y = plane.position.y + 0.01;

scene.add(sphere, shadowPlan, plane);
...
const tick = () => {
  ...
  shadowPlan.material.opacity = (1 - sphere.position.y) * 0.7;
